 ...
 * @author YASH KUMAR
 */
public class bankbook_form extends HttpServlet {
    ...
    //    int uid=Integer.parseInt(request.getParameter("userid"));
     ...
     //   }
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet bankbook_form</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet bankbook_form at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
