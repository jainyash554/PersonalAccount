 ...
 * @author YASH KUMAR
 */
public class cashbook_form extends HttpServlet {
    ...
    //    int uid=Integer.parseInt(request.getParameter("userid"));
      ...
      //  String opn = request.getParameter("opn");
       ...
       // if(opn.equals("find")){
            ...
            response.sendRedirect("cash_book?opn=find");
     //   }
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cashbook_form</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cashbook_form at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
