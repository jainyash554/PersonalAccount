 ...
 * @author YASH KUMAR
 */
public class cash_book extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
          ...
          /*   out.println("<tr bgcolor=\"black\"><th><font color=\"white\">S.NO.</font><ol start=1></ol></th><th><font color=\"white\">Date</font></th><th><font color=\"white\">Amount</font></th><th><font color=\"white\">Pay/Receive</font></th></tr>");
             ...
             for(com.yash.jdbc.cash_book.cash_book bean:ar){
                 ...
                 out.println("<tr><td><li></li></td><td>"+bean.getTran_date()+"</td><td>"+bean.getAmount()+"</td><td>"+bean.getOperation()+"</td></tr>");

            }



             out.println("<tr bgcolor=\"black\"><th colspan=2><font color=\"white\">Closing Balance</font><td colspan=2></td></tr>");
            */ out.println("</table><br><br><br>");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cash_book</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cash_book at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
