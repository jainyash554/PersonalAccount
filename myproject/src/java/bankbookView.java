    ...
    throws ServletException, IOException {
        ...
        try {
         ...
         //   out.println("<tr> <input type=\"hidden\" name=\"userid\" value="+ub.getUid()+" /></tr>");
             ...
             out.println("<table>");
             out.println("<form method=\"post\" action=\"bankbook_form?opn=find\">");
         //out.println("<form method=\"post\" action=\"cashbookView\">");



             out.println("<tr bgcolor=\"black\"><th rowspan=2><font color=\"white\">Bank Book</font></th><th><font color=\"white\">Date From</font></th><th><font color=\"white\">To</font></th><th rowspan=2><input type=\"submit\" value=\"Show\"></th></tr>");
            ...
            int i=1;
             ...
             ArrayList<bank_book> ar=cd.findAllDateWise(sdate, edate, id);

             for(bank_book bean:ar){
