 ...
 * @author YASH KUMAR
 */
public class income_categories extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
             ...
             // out.println("<form method=\"post\" action=\"expensescategory_form?opn=add\">");
              out.println("<form method=\"post\" action=\"incomecategory_form?opn=add\">");
              out.println("<table>");
              ...
              out.println("<tr><th bgcolor=\"black\" valine=\"center\" colspan=2><font color=\"white\"<h1><b>Income Categories</b></h1></font></tr><br><br><br>");
           ...
           //   income_categoryDao icd=new income_categoryDao();
             // ArrayList<income_category> list=icd.find(cid);
              ...
              out.println("<tr bgcolor=\"black\"><th><font color=\"white\">Category Name</font></th><th><font color=\"white\">Category Details</font></th><th><font color=\"white\">Edit</font></th><th><font color=\"white\">Delete</font></th><tr>");
               income_categoryDao icd=new income_categoryDao();
              ArrayList<income_category> list=icd.findAll(id);
              for(income_category bean: list){

             
              out.println("<tr>");
              out.println("<td>"+bean.getInc_catname()+"</td>");
              out.println("<td>"+bean.getInc_catdetails()+"</td>");
              out.println("<td><a href=\"incomecategoryUpdate?Inc_catid="+bean.getInc_catid()+"\">Edit</td>");
        //      out.println("<td><a href=\"expensescategory_form?opn=delete&exp_catid=" +bean.getExp_catid()+ "\">Delete</td></tr>");
              out.println("<td><a href=\"incomecategory_form?opn=delete&inc_catid="+bean.getInc_catid()+"\">Delete</td></tr>");
              out.println("</form>");
              out.println("</div>");
...
out.println("</section>");
 ...
 rd = request.getRequestDispatcher("footer.html");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet income_categories</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet income_categories at " + request.getContextPath () + "</h1>");
       */     out.println("</body>");
            out.println("</html>");
